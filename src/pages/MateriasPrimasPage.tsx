...
export default function MateriasPrimasPage() {
  ...
  const criticos = getItensCriticos({ acai: [], sorvetes: [], materias_primas: itens })
  const baixos = getItensBaixo({ acai: [], sorvetes: [], materias_primas: itens })
  ...
  return (
    <div className="space-y-6" key={version}>
      <div>
        ...
        <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Gerenciamento de insumos para produção</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatusCard titulo="Total de Itens" valor={itens.length} descricao="itens cadastrados" cor="#2E86AB" />
